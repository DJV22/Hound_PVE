...
### 2️⃣ | Optional Shell Customization
...
### 3️⃣ | Map Datasets to Containers
...
### 2️⃣ | Setup Apache Virtual Hosts
...
Next → Step 6: Game Servers & Optional Services

# Step 6 | Game Servers & Optional Services
> **Part of:** Proxmox Container Setup Guide  
...
### 2️⃣ | Install Dependencies & Configure Server
...
### 4️⃣ | Document Maintenance Schedule
